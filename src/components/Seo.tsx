...
export function Seo({ title, description, path = '/' }: SeoProps) {
  ...
  return (
    <>
      ...
      <meta property="og:image" content={`${BASE_URL}/brand/fm-og-image.png`} />
      <meta property="og:image:width" content="1200" />
      <meta property="og:image:height" content="630" />
      <meta property="og:image:alt" content="FM Consulting — growth systems for South African businesses" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content={fullTitle} />
      <meta name="twitter:description" content={desc} />
      <meta name="twitter:image" content={`${BASE_URL}/brand/fm-og-image.png`} />
    </>
  );
}
